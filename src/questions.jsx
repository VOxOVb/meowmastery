const behaviorQ = [
  {
    ...
    options: [
      { id: 0, text: "因為想幫你工作", isCorrect: false },
      { id: 1, text: "因為電腦很溫暖", isCorrect: true },
    ],
    parse:
  ...
  },
  {
    ...
    question: "喵星人比較喜歡女生...",
    options: [
      { id: 0, text: "因為女生的音頻通常比較高", isCorrect: true },
      { id: 1, text: "因為女生比較容易投餵零食", isCorrect: false },
    ],
    parse:
  ...
  },
  {
    ...
    question: "喵星人喜歡玩紙箱...",
    options: [
      { id: 0, text: "因為紙箱很香", isCorrect: false },
      { id: 1, text: "因為有安全感", isCorrect: true },
    ],
    parse:
  ...
  },
  {
    ...
    question: "喵星人飛機耳...",
    options: [
      { id: 0, text: "飛機準備起飛!", isCorrect: false },
      { id: 1, text: "再鬧我開咬喔", isCorrect: true },
    ],
    parse:
  ...
  },
  {
    ...
    question: "喵星人搖尾巴...",
    options: [
      { id: 0, text: "我好興奮啊!", isCorrect: false },
      { id: 1, text: "我在生氣別惹我", isCorrect: true },
    ],
    parse:
  ...
  },
  {
    ...
    question: "喵星人露出水汪汪大眼...",
    options: [
      { id: 0, text: "裝可愛撒嬌，快賞我肉泥", isCorrect: false },
      { id: 1, text: "在非常興奮專注的狀態", isCorrect: true },
    ],
    parse:
  ...
  },
  {
    ...
    question: "喵星人踏踏...",
    options: [
      { id: 0, text: "心情很放鬆", isCorrect: true },
      { id: 1, text: "最可愛麵包師傅上工", isCorrect: false },
    ],
    parse:
  ...
  },
  {
    ...
    options: [
      { id: 0, text: "心情很放鬆", isCorrect: true },
      { id: 1, text: "他踩下油門他的引擎大聲", isCorrect: false },
    ],
    parse:
...
const foodQ = [
  {
    ...
    question: "在喵星人的罐罐中加水...",
    options: [
      { id: 0, text: "你想把我淹死嗎", isCorrect: false },
      { id: 1, text: "多喝水還不錯", isCorrect: true },
    ],
    parse:
  ...
  },
  {
    ...
    question: "喵星人吃巧克力...",
    options: [
      { id: 0, text: "不行!我會毒死", isCorrect: true },
      { id: 1, text: "給我吃一點沒關係啦", isCorrect: false },
    ],
    parse:
  ...
  },
  {
    ...
    question: "喵星人喝牛奶...",
    options: [
      { id: 0, text: "動畫裡都喜歡喝牛奶", isCorrect: false },
      { id: 1, text: "我不可以喝", isCorrect: true },
    ],
    parse:
...
const itemQ = [
  {
    ...
    question: "和喵星人玩雷射筆...",
    options: [
      { id: 0, text: "我超愛這玩具", isCorrect: false },
      { id: 1, text: "抓不到讓我好挫折", isCorrect: true },
    ],
    parse:
  ...
  },
  {
    ...
    question: "喵星人對於貓薄荷...",
    options: [
      { id: 0, text: "沒錯我超愛", isCorrect: true },
      { id: 1, text: "我會成癮不好", isCorrect: false },
    ],
    parse:
  ...
  },
  {
    ...
    question: "喵星人對於貓草...",
    options: [
      { id: 0, text: "我不喜歡", isCorrect: false },
  ...
  },
  {
    ...
    question: "喵星人的廁所...",
    options: [
      { id: 0, text: "安靜隱蔽的角落", isCorrect: true },
      { id: 1, text: "走廊通風避免臭臭", isCorrect: false },
    ],
    parse:
  ...
  },
  {
    ...
    question: "喵星人洗澡...",
    options: [
      { id: 0, text: "我自己會洗澡", isCorrect: true },
      { id: 1, text: "口水臭臭要幫我洗", isCorrect: false },
    ],
    parse:
  ...
  },
  {
    ...
    question: "幫喵星人穿衣服...",
    options: [
      { id: 0, text: "我的毛就夠好看", isCorrect: true },
      { id: 1, text: "我超喜歡", isCorrect: false },
    ],
    parse:
  ...
  //     question: "抓喵星人前腳抱抱...",
  //     options: [
  //       { id: 0, text: "我超級喜歡", isCorrect: false },
  //       { id: 1, text: "我不喜歡", isCorrect: true },
  //     ],
  //     parse:
  ...
  //   },
  {
    ...
    question: "幫喵星人剪指甲...",
    options: [
      { id: 0, text: "我很需要", isCorrect: true },
      { id: 1, text: "我自己就會磨爪，不需要", isCorrect: false },
    ],
    parse:
